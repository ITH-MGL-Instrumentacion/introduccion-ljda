...
%	{\large \textbf{Unidad 1: Morfología del robot}}\\
	...
	\begin{center}
		\begin{tabular}{c c}
			\begin{tabular}{c}
				\includegraphics[height=3cm]{FOTO DE PERFIL.jpg} \\
				\textbf{Canizales Laborin},\\ Juan Angel \\ \texttt{l23330022@hermosillo.tecnm.mx} \\ Teléfono: (6621250835)
			\end{tabular} &
			\begin{tabular}{c}
				\includegraphics[height=3cm]{FOTO DIAZ.jpg} \\
				\textbf{Diaz Guajardo,}\\ Jose Manuel \\ \texttt{l23330034@hermosillo.tecnm.mx} \\ Teléfono: (6624765563)
			\end{tabular} \\ \vspace{2em}
			\begin{tabular}{c}
				\includegraphics[height=3cm]{FOTO LEX.jpg} \\
				\textbf{Miranda Velarde,}\\ Lex Alberto \\ \texttt{l23330079@hermosillo.tecnm.mx} \\ Teléfono: (6624794922)
			\end{tabular} &
			\begin{tabular}{c}
